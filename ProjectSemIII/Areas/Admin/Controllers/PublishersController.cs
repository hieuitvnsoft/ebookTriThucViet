...
namespace ProjectSemIII.Areas.Admin.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PublisherId,PublisherName,PublisherPhone,Email,PublisherAddress,Note")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PublisherId,PublisherName,PublisherPhone,Email,PublisherAddress,Note")] Publisher publisher)
        {
            if (ModelState.IsValid)
            {
