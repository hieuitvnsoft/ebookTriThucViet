...
namespace ProjectSemIII.Areas.Admin.Controllers
{
    public class BanksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BankId,BankName,StringBankSevice,Address,BankPhone,BankEmail")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BankId,BankName,StringBankSevice,Address,BankPhone,BankEmail")] Bank bank)
        {
            if (ModelState.IsValid)
            {
